...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<div class="sidebar-heading" name="adminSetting" value="adminSetting" 
			style="display:<sec:authentication property="principal.username" var="userid" />
		...
		<br>
			...
			<p>
				...
				<button type="submit" class="btn btn-success btn-flat" formaction="/workflow/modify" formmethod="get">수정</button>
				<button type="submit" class="btn btn-success btn-flat" formaction="/workflow/remove" formmethod="post">삭제</button>
				<button type="submit" class="btn btn-success btn-flat" formaction="/workflow/workflow2" formmethod="get">목록</button>
		</form>		
</div>
		<!-- Reply Form End -->
</div>
