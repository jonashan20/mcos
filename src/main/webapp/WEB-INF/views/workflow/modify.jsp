...
<body id="page-top">
    ...
    <div id="wrapper">
		...
		<!-- search{e} -->
                ...
                <div class="box box-primary">
					 ...
					 <h6 class="m-0 font-weight-bold text-primary">워크플로우 신청글</h6>
                    </div>
                    <div class="box-body">
	...
	<form>
			...
			<br>
			<button type="submit" formaction="/workflow/modify" formmethod="post" class="btn btn-success btn-flat">완료</button>
	</form>
	</div>
		<!-- Reply Form End -->
</div>
