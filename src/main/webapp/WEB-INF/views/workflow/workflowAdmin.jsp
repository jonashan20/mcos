...
function fn_prev(page, range, rangeSize, searchType, keyword) {
		...
		var range = range - 1;
		var url = "${pageContext.request.contextPath}workflowAdmin"; <!-- ex)workflow2 /가 있는 상태는 현재페이지에서 현재 url로 간다는뜻이고 /가 없이 workflow2는 현재페이지에서 /현재페이지/workflow2가 된다는것임-->
	...
	function fn_next(page, range, rangeSize, searchType, keyword) {
		...
		var url = "${pageContext.request.contextPath}workflowAdmin";
