...
<form method="post" action="CommunityModify">
<body id="page-top">
		...
		<div class="box box-primary">
			...
			<div class="box-body">
				...
				<div class="form-group">
					...
					<input class="form-control" id="title" name="title" value="${commVO.title}">
				</div>
				<div class="form-group">
					<label for="comContent">내용</label>
					<textarea class="form-control" id="comContent" name="comContent" rows="30"
						style="resize: none;">${commVO.comContent}</textarea>
				</div>
				<div class="form-group">
					<label for="username">작성자</label>
					<input  class="form-control" id="username" name="username" value="${commVO.username}" readonly>
				</div>
			</div>
