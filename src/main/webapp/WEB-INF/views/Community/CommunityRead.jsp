<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" /> <%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
	...
	<ol class="replyList">
		<c:forEach items="${replyList}" var="replyList">
			<li>
				...
				작성날짜:<fmt:formatDate value="${replyList.writeDate}" pattern="yyyy-MM-dd"/>
				</p>
...
<form name="replyForm" method="post">
	<input type="hidden" id="comid" name="comid" value="${read.comid}" />
	<input type="hidden" id="page" name="page" value="${search.page}" />
	<input type="hidden" id="listSize" name="listSize" value="${search.listSize}" />
	...
	<div>
		<label for="username">댓글 작성자</label><input type="text" id="username" name="username" />
		<br/>
