...
<body id="page-top">
<script>
	<c:url var="CommunityListURL" value="/Community/CommunityList">
	</c:url>
	//이전 버튼 이벤트
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="../EvaluationList">직원평가 리스트</a>
                        <a class="collapse-item active" href="../insurance.jsp">insurance Page</a>
                    </div>
                </div>
            </li>
...
<div class="form-group row justify-content-center">
    <div class="w100" style="padding-right:10px">
         <select class="form-cntrol form-control-sm" name="searchType" id="searchType">
             <option value="title">제목</option>
             <option value="comContent">본문</option>
...
<div class="col-lg-12">
	<div class="box box-primary">
		<div class="box-header with-border">
			<h3 class="box-title">커뮤니티 글 목록</h3>
		</div>
		<div class="box-body">
			<table class="table table-bordered">
				<tbody>
					...
					<tr>
						<td>${CommunityVO.comid}</td>
						<td><a href="${path}/Community/CommunityRead?comid=${CommunityVO.comid}">${CommunityVO.title}</a></td>
						<td>${CommunityVO.username}</td>
						<td hidden="true">${CommunityVO.userid}</td>
						<td><fmt:formatDate pattern="yyyy-MM-dd a HH:mm" value="${CommunityVO.writeDate}" /></td>
						<td><span class="badge badge-danger">${CommunityVO.reads}</span></td>
					</tr>
					</c:forEach>
				</tbody>
			</table>
	...
	<form action="CommunityRegist" method="get">
	...
	<ul class="pagination justify-content-center">
		...
		<c:forEach begin="${Pagination.startPage}" end="${Pagination.endPage}" var="idx">
			...
			<a class="page-link" href="#" onClick="fn_pagination('${idx}',
				'${Pagination.range}', '${Pagination.rangeSize}')">${idx}</a></li>
		</c:forEach>
		
		<c:if test="${Pagination.next}"><li class="page-item">
			<a class="page-link" href="#" onClick="fn_next('${Pagination.range}', '${Pagination.range}', '${Pagination.rangeSize}')">다음</a></li>
		</c:if> 
	</ul>
</div>
<!-- pagination(e) -->
